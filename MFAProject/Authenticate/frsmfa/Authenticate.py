...
class mfaconfig():
    def __init__(self):
        ...
        self.weights={
            'lip':'./Authenticate/frsmfa/weights/lipnet.h5',
            'speech' :  './Authenticate/frsmfa/weights/w2v.pth',
            'speaker':'./Authenticate/frsmfa/weights/rawnet2.pt'
            }
        self.decoders={
            'speech':srdecoder(),
            'lip' :  vsrdecoder('./Authenticate/frsmfa/weights/'),
            'speaker':spkrdecoder()
            }
...
class MultifactorAuthentication():
      ...
      def Authenticate(self,testaudio,testvideo,enrollmentembedding):
          ...
          print( [levenshtein(speechresult, self.otp),levenshtein(lipresult, self.otp),spkrresult])
          return True
...
#result = mfa.authenticate(databaseEmbedding,currentAudio,currentVideo)
